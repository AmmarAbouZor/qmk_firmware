...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [SYMB_NAV] = LAYOUT_ansi_82(
        ...
        CW_TOGG,  KC_TILDE,   KC_AT,  KC_HASH, KC_DOLLAR, KC_PERCENT, KC_CIRC,  KC_AMPR, KC_ASTR,  KC_LPRN,  KC_RPRN, KC_LCBR,    KC_RCBR,  _______,            _______,
         KC_SPC, KC_EXCLAIM, HOME_MINS, HOME_PLUS, KC_EQL, KC_UNDS,   KC_LEFT,  KC_DOWN,    KC_UP,  KC_RGHT,  KC_PIPE,  KC_GRV,               KC_APP,            _______,
...
// Disable quick term for backspace, Layer-switch, Control and Shift
