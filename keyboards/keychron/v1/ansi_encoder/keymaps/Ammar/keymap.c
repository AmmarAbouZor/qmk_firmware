...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ansi_82(
        ...
        LT(NUMS,KC_ESC), LALT_T(KC_A), LGUI_T(KC_S), LSFT_T(KC_D), LCTL_T(KC_F), KC_G, KC_H, LCTL_T(KC_J), LSFT_T(KC_K), LGUI_T(KC_L), LALT_T(KC_SCLN),  KC_QUOT, LT(NUMS,KC_ENT),  KC_HOME,
    ...
    [SYMB_NAV] = LAYOUT_ansi_82(
        ...
        _______,            _______,   KC_GRV,  KC_LBRC,  KC_RBRC,  CW_TOGG,  KC_LCBR,  KC_RCBR,    KC_LT,    KC_GT,   KC_BSLS,              KC_CAPS,  _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,    _______,  _______,  _______,  _______),
...
const uint16_t PROGMEM sd_combo[] = {LGUI_T(KC_S), LSFT_T(KC_D), COMBO_END};
