...
#define HOME_G MT(MOD_LSFT | MOD_LALT, KC_G)
#define HOME_J LCTL_T(KC_J)
#define HOME_K LSFT_T(KC_K)
#define HOME_L LGUI_T(KC_L)
#define HOME_SC LALT_T(KC_SCLN)
#define HOME_CAPS LT(NAV_NUMS, KC_ESC)
#define HOME_ENT LT(NAV_NUMS, KC_ENT)
#define HOME_SPC LT(SYMB, KC_SPC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ansi_82(
        ...
        KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_BSPC,  KC_BSPC,  KC_BSLS,            KC_PGDN,
        HOME_CAPS, HOME_A, HOME_S,  HOME_D,   HOME_F,   HOME_G,     KC_H,   HOME_J,   HOME_K,     HOME_L,  HOME_SC,  HOME_ENT,            HOME_ENT,            KC_HOME,
    ...
    [SYMB] = LAYOUT_ansi_82(
        ...
        _______,  KC_TILDE,   KC_AT,  KC_HASH, KC_DOLLAR, KC_PERCENT, KC_CIRC,  KC_AMPR, KC_ASTR,  KC_PIPE,  KC_BSLS, _______,    _______,  _______,            _______,
        _______, KC_EXCLAIM, KC_MINS, KC_PLUS,   KC_EQL,  KC_LBRC,   KC_LPRN,  KC_LCBR,  KC_UNDS,  KC_QUOT,   KC_DQT, _______,              _______,            _______,
        _______,            _______,  _______,  _______,   KC_GRV,   KC_RBRC,  KC_RPRN,  KC_RCBR,    KC_LT,    KC_GT, KC_QUES,              KC_CAPS,  _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,    _______,  _______,  _______,  _______),

    [NAV_NUMS] = LAYOUT_ansi_82(
        _______,  KC_BRID,  KC_BRIU,  KC_TASK,  KC_FLXP,  RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,    KC_VOLU,  _______,            _______,
        _______,    KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,   KC_F10,   KC_F11,     KC_F12,  _______,            _______,
        _______,  _______,     KC_7,     KC_8,     KC_9,   KC_APP,  _______,  KC_PGUP,  KC_BSPC,  KC_PGDN,  _______,  _______,    _______,  _______,            _______,
        _______,     KC_0,     KC_4,     KC_5,     KC_6,  KC_LCTL,  KC_LEFT,  KC_DOWN,    KC_UP,  KC_RGHT,  _______,  _______,              _______,            _______,
        _______,            _______,     KC_1,     KC_2,     KC_3,  CW_TOGG,   KC_TAB,   KC_ENT,  KC_HOME,   KC_END,  _______,              _______,  _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,    _______,  _______,  _______,  _______),
};
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [SYMB] = { ENCODER_CCW_CW(WIN_DESK_PREV, WIN_DESK_NEXT)},
    [NAV_NUMS]   = { ENCODER_CCW_CW(RGB_VAD, RGB_VAI)}
};
