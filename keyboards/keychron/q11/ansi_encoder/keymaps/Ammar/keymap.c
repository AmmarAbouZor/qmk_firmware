...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_91_ansi(
        ...
        _______,  LT(NAV,KC_ESC), LALT_T(KC_A), LGUI_T(KC_S), LSFT_T(KC_D), LCTL_T(KC_F), KC_G, KC_H, LCTL_T(KC_J), LSFT_T(KC_K), LGUI_T(KC_L), LALT_T(KC_SCLN),  KC_QUOT, LT(NAV,KC_ENT), KC_HOME,
    ...
    [SYMBOL] = LAYOUT_91_ansi(
        ...
        _______,  _______, KC_EXCLAIM, KC_MINS, KC_PLUS,  KC_EQL,  KC_LCBR,   KC_RCBR,  KC_UNDS,  KC_PIPE,  KC_LBRC,  KC_RBRC,  _______,              _______,            _______,
        _______,  _______,            _______,  _______,  _______,  _______,   _______,  _______,  _______,  KC_LT,  KC_GT,  _______,              _______,  _______,
        _______,  _______,  _______,  _______,  _______,            _______,                       _______,            _______,  _______,    _______,  _______,  _______,  _______),
    ...
    [NAV] = LAYOUT_91_ansi(
        ...
        _______,  _______,  KC_LALT,  KC_LGUI,  KC_LSFT,  KC_LCTL,  _______,   KC_LEFT,  KC_DOWN,    KC_UP,  KC_RGHT,  KC_END,  _______,              _______,            _______,
