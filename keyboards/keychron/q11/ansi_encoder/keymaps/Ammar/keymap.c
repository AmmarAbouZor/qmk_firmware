...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_91_ansi(
        ...
        _______,  KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,      KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_BSPC,    KC_EQL,   KC_BSPC,            KC_PGUP,
        _______,  KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,      KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_ENT,    KC_RBRC,  KC_BSLS,            KC_PGDN,
    ...
    [SYMB_NAV] = LAYOUT_91_ansi(
        ...
        _______,  _______,            _______,  _______,   KC_GRV,  KC_LCBR,  KC_RCBR,  KC_LBRC,  KC_RBRC,    KC_LT,    KC_GT,   KC_BSLS,              KC_CAPS,  _______,
        _______,  _______,  _______,  _______,  _______,            _______,                       _______,            _______,  _______,    _______,  _______,  _______,  _______),
